            ...
            {context.isOpen && (
                <>
                    <motion.div
                        ...
                        aria-modal='true'
                        className={cn(
                            'absolute overflow-hidden rounded-md border border-zinc-950/10 bg-white p-2 text-zinc-950 shadow-md dark:border-secondary dark:bg-base-300 dark:text-zinc-50',
                            className
                        )}
                        initial='initial'
                        animate='animate'
